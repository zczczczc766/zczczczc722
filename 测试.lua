...
local loadSuccess, loadErr = pcall(function()
    B = loadstring(game:HttpGet("https://raw.githubusercontent.com/951357nvjn/dyzs/refs/heads/main/winduiYI.lua"))()
end)

if not loadSuccess or not B then
    A:SetCore("SendNotification", {
        Title = "加载失败",
        Text = "WindUI 库加载失败，请检查网络或联系作者。",
        Duration = 5
    })
    return
end
...
Z:Button({
    Title = "复制作者QQ",
    Callback = function()
        setclipboard("2047955671")
        A:SetCore("SendNotification", { Title = "已复制", Text = "作者QQ：2047955671", Duration = 2 })
    end
})
Z:Button({
    Title = "复制作者QQ群",
    Callback = function()
        setclipboard("1101093219")
        A:SetCore("SendNotification", { Title = "已复制", Text = "作者QQ群：1101093219", Duration = 2 })
    end
})
Z:Button({
    Title = "复制作者QQ副群",
    Callback = function()
        setclipboard("1063828524")
        A:SetCore("SendNotification", { Title = "已复制", Text = "作者QQ副群：1063828524", Duration = 2 })
    end
})
...
E:Button({
    Title = "飞行",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/zczczczc766/ink/refs/heads/main/%E9%A3%9E%E8%A1%8C%E8%84%9A%E6%9C%AC.lua"))()
    end
})
...
local P1 = D:Tab({ Title = "透视专区", Icon = "eye" })
...
local P2 = D:Tab({ Title = "其它脚本", Icon = "code" })
P2:Button({ Title = "被遗弃角色|皮肤修改器", Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/zczczczc766/ink/refs/heads/main/%E8%A2%AB%E9%81%97%E5%BC%83%E8%A7%92%E8%89%B2or%E7%9A%AE%E8%82%A4%E5%88%87%E6%8D%A2%E5%99%A8.lua"))() end })
P2:Button({ Title = "夜脚本", Callback = function() loadstring(game:HttpGet("https://raw.githubusercontent.com/ylt410/roblox-Script/refs/heads/main/yejiaoben"))() end })
P2:Button({ Title = "ROB脚本", Callback = function() loadstring(game:HttpGet("https://raw.gitcode.com/ROB5201314/robscript/raw/main/ROB.V3"))() end })
        ...
        if s then
            ...
            guestBlockThread = task.spawn(function()
                ...
                while guestBlockEnabled do
                    Event:FireServer("UseActorAbility", {
                        (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 5, 0, 0, 0, 66, 108, 111, 99, 107 })
                    })
                    task.wait(0.01)
                end
            end)
...
guestChargeThread = task.spawn(function()
    ...
    while guestChargeEnabled do
        Event:FireServer("UseActorAbility", {
            (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 6, 0, 0, 0, 67, 104, 97, 114, 103, 101 })
        })
        task.wait(0.01)
    end
end)
        ...
        if s then
            ...
            shedletskySlashThread = task.spawn(function()
                ...
                while shedletskySlashEnabled do
                    Event:FireServer("UseActorAbility", {
                        (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 5, 0, 0, 0, 83, 108, 97, 115, 104 })
                    })
                    task.wait(0.01)
                end
            end)
        ...
        if s then
            ...
            pizzaThrowThread = task.spawn(function()
                ...
                while pizzaThrowEnabled do
                    Event:FireServer("UseActorAbility", {
                        (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 10, 0, 0, 0, 84, 104, 114, 111, 119, 80, 105, 122, 122, 97 })
                    })
                    task.wait(0.01)
                end
            end)
        ...
        if s then
            ...
            noobDestructionThread = task.spawn(function()
                ...
                while noobDestructionEnabled do
                    Event:FireServer("UseActorAbility", {
                        (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 8, 0, 0, 0, 84, 105, 109, 101, 115, 116, 111, 112 })
                    })
                    task.wait(0.01)
                end
            end)
        ...
        if s then
            ...
            clone007Thread = task.spawn(function()
                ...
                while clone007Enabled do
                    Event:FireServer("UseActorAbility", {
                        (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 5, 0, 0, 0, 67, 108, 111, 110, 101 })
                    })
                    task.wait(0.01)
                end
            end)
        ...
        if s then
            ...
            taphMineThread = task.spawn(function()
                ...
                while taphMineEnabled do
                    Event:FireServer("UseActorAbility", {
                        (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 16, 0, 0, 0, 83, 117, 98, 115, 112, 97, 99, 101, 84, 114, 105, 112, 109, 105, 110, 101 })
                    })
                    task.wait(0.01)
                end
            end)
        ...
        if s then
            ...
            flashbangThread = task.spawn(function()
                ...
                while flashbangEnabled do
                    Event:FireServer("UseActorAbility", {
                        (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 9, 0, 0, 0, 70, 108, 97, 115, 104, 98, 97, 110, 103 })
                    })
                    task.wait(0.01)
                end
            end)
        ...
        if s then
            ...
            guest666Thread = task.spawn(function()
                ...
                while guest666Enabled do
                    Event:FireServer("UseActorAbility", {
                        (function(bytes) local b = buffer.create(#bytes) for i = 1, #bytes do buffer.writeu8(b, i - 1, bytes[i]) end return b end)({ 3, 14, 0, 0, 0, 68, 101, 109, 111, 110, 105, 99, 80, 117, 114, 115, 117, 105, 116 })
                    })
                    task.wait(0.01)
                end
            end)
